#!/bin/bash
# =============================================================================
# Traccarocra - Script de Backup PRODUCCION
# =============================================================================
set -e
...
echo "============================================="
echo "[Traccarocra] Backup PRODUCCION - $DATE"
echo "============================================="
...
docker exec ${PROJECT}_postgres pg_dump -U postgres -d ${PROJECT}_prod > "$DB_BACKUP"
gzip "$DB_BACKUP"
...
echo "============================================="
echo "✓ Backup producción completado: $DATE"
echo "============================================="
